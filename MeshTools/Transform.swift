...
open class Transform   {
    ...
    public func alter(arrow: Vector3D) -> Vector3D {
        
        let dir4 = RowMtx4(valOne: arrow.i, valTwo: arrow.j, valThree: arrow.k, valFour: 0.0)
        let vec4 = dir4 * self
