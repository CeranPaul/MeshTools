...
class PlaneTests: XCTestCase {
    ...
    func testBuildParallel()   {
        ...
        let build1 = try! Plane.buildParallel(base: groundFloor, offset: 1.2, reverse: false)
        ...
        let build2 = try! Plane.buildParallel(base: groundFloor, offset: 1.2, reverse: true)
...
//        do   {
//
//            _ = Plane.buildPerpThruLine(enil: heli, enalp: groundFloor)
//
...
//
//        let standup = Plane.buildPerpThruLine(enil: heli, enalp: groundFloor)
//
